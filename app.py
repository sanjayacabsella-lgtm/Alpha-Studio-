...
def check_user_access(username):
    # Developer හට Unlimited ලබා දීම
    if username == "Hasith": return True, 0, True
...
with tab_img:
    ...
    # ඔයා එවපු ලිස්ට් එකේ තියෙන ලාභම (1 pollen models) මෙතනට ඇතුළත් කළා
            ...
            if can_gen:
                with st.spinner("Alpha is painting... 🖌️"):  
                    try:  
                        ...
                        # URL එකේ model එක නිවැරදිව පරාමිතියක් ලෙස යැවීම
